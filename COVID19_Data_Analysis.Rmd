...
required_packages <- c(
  ...
  "ggplot2","ggthemes","glmnet", "gridExtra", "htmltools",
   "kableExtra", "knitr","leaflet", "lubridate", "purrr", 
...
# Display of the column names and the first few rows of the data sets
...
```{r Tranform Data Column names, echo=TRUE, fig.height=10.5, fig.width=8}
knitr::opts_chunk$set(echo = TRUE, tidy.opts = list(width.cutoff = 80), tidy = TRUE)
...
# Rename columns in global data sets
...
# Rename columns in US data sets
...
```{r Create Pivot tables, echo=TRUE, fig.height=10.5, fig.width=8, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(echo = TRUE, tidy.opts = list(width.cutoff = 80), tidy = TRUE)
...
```{r Combine US data, echo=TRUE, fig.height=10.5, fig.width=8, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(echo = TRUE, tidy.opts = list(width.cutoff = 80), tidy = TRUE)
